var iconcolor = "rgb(19, 189, 126)";
$(document).ready(function() {
	var color2= ["#531010","#e76074","#531010","#932a3a","#932a3a","#bf2729","rgb(207, 66, 66)"];
	var color3 = ["#590b4d","#b61fcb","#53155b","#780b8d","#780b8d","#9429a8","rgb(178, 35, 197)"];
	var color4 = ["#0c2159","#26abf6","#0a1f69","#3c6bb0","#3c6bb0","#3d66a0","rgb(22, 126, 249)"];
	var color1 = ["#207f5f","#31db9b","#000","#235e4a","#235e4a","#235e4a","rgb(19, 189, 126)"];
